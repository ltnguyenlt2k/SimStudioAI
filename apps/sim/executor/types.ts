...
export interface ExecutionMetadata {
  ...
  // NEW: data dùng để export thêm file
  customExportData?: Record<string, any>
}
...
export interface CustomExportStore {
...
export interface ExecutionContext {
  ...
  // ... các field có sẵn
  customExportStore?: CustomExportStore   // <--- thêm dòng này
